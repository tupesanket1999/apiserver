                ...
                if (operationDoc) {
                    ...
                    if (operationContext.allowsFeatures) {
                        ...
                        if (operationDoc.responses &&
                            ...
                            var ResponseValidatorClass = ((_a = _this.features) === null || _a === void 0 ? void 0 : _a.responseValidator) || openapi_response_validator_1["default"];
                            ...
                            var responseValidator = new ResponseValidatorClass({
                        ...
                        if (methodParameters.length || operationDoc.requestBody) {
                            ...
                            if (util_1.allowsValidationFeature(_this, _this.apiDoc, pathModule, pathDoc, operationDoc)) {
                                var RequestValidatorClass = ((_b = _this.features) === null || _b === void 0 ? void 0 : _b.requestValidator) || openapi_request_validator_1["default"];
                                var requestValidator = new RequestValidatorClass({
                                    errorTransformer: _this.errorTransformer,
                                    logger: _this.logger,
                            ...
                            if (util_1.allowsCoercionFeature(_this, _this.apiDoc, pathModule, pathDoc, operationDoc)) {
                                var CoercerClass = ((_c = _this.features) === null || _c === void 0 ? void 0 : _c.coercer) || openapi_request_coercer_1["default"];
                                var coercer = new CoercerClass({
                            ...
                            if (methodParameters.filter(util_1.byDefault).length &&
                                ...
                                var DefaultSetterClass = ((_d = _this.features) === null || _d === void 0 ? void 0 : _d.defaultSetter) || openapi_default_setter_1["default"];
                                var defaultSetter = new DefaultSetterClass({
                                    parameters: methodParameters
                                });
                        ...
                        if (securityDefinition) {
                            ...
                            var SecurityHandlerClass = ((_e = _this.features) === null || _e === void 0 ? void 0 : _e.securityHandler) || openapi_security_handler_1["default"];
